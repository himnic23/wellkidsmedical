const translations = {
    ...
    zh: {
        ...
        services: {
            title: "兒科服務",
            description: "我們的專業兒科服務旨在為新生兒到青少年提供全面的醫療保健。",
            general_medicine: "普通兒科",
            general_medicine_desc: "為各年齡段兒童提供全面的醫療保健。",
            pediatrics: "新生兒護理",
            pediatrics_desc: "為新生兒和嬰兒提供專業護理。",
            cardiology: "兒科心臟病學",
            cardiology_desc: "為兒童心臟疾病提供專業治療。",
            dermatology: "兒科皮膚科",
            dermatology_desc: "為兒童皮膚疾病提供治療。",
            orthopedics: "兒科骨科",
